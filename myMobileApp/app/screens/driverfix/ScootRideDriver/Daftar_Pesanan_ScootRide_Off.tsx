...
const Daftar_Pesanan_ScootRide_Off = () => {
  const offImage = require('../../../../assets/images/Off.png');
  const router = useRouter();

  const handleToggle = () => {
    router.push('/screens/driverfix/ScootRideDriver/Daftar_Pesanan_ScootRide_On');
  };
...
export default Daftar_Pesanan_ScootRide_Off;