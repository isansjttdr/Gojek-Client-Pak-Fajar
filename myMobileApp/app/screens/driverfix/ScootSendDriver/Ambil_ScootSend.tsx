...
const AmbilScootSend = () => {
  ...
  const { orderId, time, pickup, destination, price } = useLocalSearchParams();
      ...
      <SafeAreaView style={styles.viewBg}>
        <View style={[styles.view, styles.viewBg]}>
          ...
          <View style={styles.pickupContainer}>
            ...
            <Text style={styles.locationText}>{pickup || "Kos kembang indah jaya"}</Text>
          </View>

          {/* Destination Location */}
          <View style={styles.destinationContainer}>
            <View style={styles.dot} />
            <Text style={styles.locationText}>{destination || "UPT TIK Fatisda"}</Text>
          </View>
