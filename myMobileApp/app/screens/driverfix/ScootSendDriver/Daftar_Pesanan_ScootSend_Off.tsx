...
const Daftar_Pesanan_ScootSend_Off = () => {
  const offImage = require('../../../../assets/images/Off.png');
  const router = useRouter();

  const handleToggle = () => {
    router.push('/screens/driverfix/ScootSendDriver/Daftar_Pesanan_ScootSend_On');
  };
...
export default Daftar_Pesanan_ScootSend_Off;